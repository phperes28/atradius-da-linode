...
def generate_annual_review_with_supplier(buyer_number, buyer_name, contact_name, fins_1, fins_2, previous_contact):
    ...
    Would you please assist us once again as we are conducting an annual review on {buyer_name} and we require updated financial information so we are able to make a proper risk
    assessment. Based on this information we will decide whether to roll over your status as covered buyer in our database.\n 
